...
public class MedicationForm : Form
{
    ...
    private List<Medication> _filtered = [];
    ...
    private Panel BuildToolbar()
    {
        ...
        txtSearch = new TextBox
        {
            ...
            BackColor = Color.White,
            PlaceholderText = "Search medications..."
        };
    ...
    private Panel BuildGridCard()
    {
        ...
        lblNoData = UIHelper.CreateEmptyDataLabel("No medications found.");
    ...
    private void FilterData()
    {
        ...
        _filtered = _data.Where(x =>
        {
            ...
            bool searchMatch = string.IsNullOrWhiteSpace(q) ||
                ...
                x.DosageForm?.ToLower().Contains(q) == true;
    ...
    private void RefreshGrid()
    {
        ...
        if (dgv.Columns["Name"] is { } cNm) { cNm.HeaderText = "Name"; cNm.FillWeight = 22; }
        if (dgv.Columns["Category"] is { } cCa) { cCa.HeaderText = "Category"; cCa.FillWeight = 16; }
        if (dgv.Columns["DosageForm"] is { } cDf) { cDf.HeaderText = "Dosage Form"; cDf.FillWeight = 14; }
        if (dgv.Columns["Unit"] is { } cUn) { cUn.HeaderText = "Unit"; cUn.FillWeight = 10; }
    ...
    private void BtnAdd_Click(object? s, EventArgs e)
    {
        ...
        VetMS.Forms.Toast.Success("Medication saved!");
        LoadData();
    }
    ...
    private void EditRow(int rowIndex)
    {
        ...
        VetMS.Forms.Toast.Success("Medication updated!");
        LoadData();
    }
    ...
    private void DeleteRow(int rowIndex)
    {
        ...
        VetMS.Forms.Toast.Success("Medication deactivated!");
        LoadData();
    }
    ...
    private void RecoverRow(int rowIndex)
    {
        ...
        VetMS.Forms.Toast.Success("Medication recovered!");
        LoadData();
    }
...
public class MedicationDialog : Form
{
    ...
    private readonly ComboBox cboDosageForm;
    ...
    [
        "Antibiotic","Antiparasitic","Analgesic","Anti-inflammatory",
        "Vaccine","Vitamin","Antifungal","Sedative","Other"
    ];

    private static readonly string[] DosageForms =
    [
        "Tablet","Capsule","Injection","Syrup",
        "Powder","Cream","Drops","Spray","Other"
    ];
    ...
    public MedicationDialog(Medication? existing = null)
    {
        ...
        body.Controls.Add(FieldLabel("Medication Name *", lm, y)); y += 22;
        txtName = StyledTextBox(lm, y); body.Controls.Add(txtName); y += 44;

        body.Controls.Add(FieldLabel("Category *", lm, y)); y += 22;
        cboCategory = StyledCombo(lm, y);
        cboCategory.Items.AddRange(Categories);
        body.Controls.Add(cboCategory); y += 44;

        body.Controls.Add(FieldLabel("Dosage Form *", lm, y)); y += 22;
        cboDosageForm = StyledCombo(lm, y);
        cboDosageForm.Items.AddRange(DosageForms);
        body.Controls.Add(cboDosageForm); y += 44;

        body.Controls.Add(FieldLabel("Unit", lm, y)); y += 22;
        txtUnit = StyledTextBox(lm, y); body.Controls.Add(txtUnit); y += 44;

        body.Controls.Add(FieldLabel("Description", lm, y)); y += 22;
        txtDesc = StyledTextBox(lm, y, multiline: true); body.Controls.Add(txtDesc); y += 88;

        body.Controls.Add(FieldLabel("Approved Suppliers", lm, y)); y += 22;
        ...
        foreach (var s in _allSuppliers) clbSuppliers.Items.Add(s);
        ...
        if (isEdit)
        {
            ...
            cboCategory.SelectedItem = existing.Category;
            cboDosageForm.SelectedItem = existing.DosageForm;
    ...
    private void BtnSave_Click(object? sender, EventArgs e)
    {
        ...
        { VetMS.Forms.CustomMessageBox.Show("Medication name is required.", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning); return; }
        ...
        if (cboDosageForm.SelectedItem == null)
        ...
        SelectedSupplierIds = clbSuppliers.CheckedItems
            .Cast<Supplier>()
            .Select(x => x.Id)
            .ToList();
    ...
    // ── Shared helpers (mirror BreedDialog) ───────────────────────────────────
    ...
    {
        var p = new Panel { Left = x, Top = y, Width = 230, Height = 40, BackColor = Color.FromArgb(248, 249, 251) };
